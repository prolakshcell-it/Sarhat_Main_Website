                ...
                >
                  ...
                  {isActive ? (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="px-3.5 py-1 bg-black/60 border border-white/20 text-white font-mono text-[10px] sm:text-[11px] font-bold rounded-full backdrop-blur-md uppercase tracking-wider flex items-center gap-2">
                          <span
                            className="w-2 h-2 rounded-full animate-ping bg-[#5EE72D]"
                          ></span>
                          {item.tag}
                        </span>
                      ...
                      <div className="max-w-xl">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          <span
                            className="w-2.5 h-2.5 rounded-full bg-[#5EE72D] shadow-[0_0_10px_#5EE72D]"
                          ></span>
                    ...
                    <div className="absolute inset-0 p-4 sm:p-6 flex lg:flex-col items-center justify-between z-20">
                      {/* Top Icon */}
                      <div className="w-10 h-10 rounded-xl bg-black/60 border border-white/15 flex items-center justify-center text-[#5EE72D] backdrop-blur-md">
                        <IconComp className="w-5 h-5 text-[#5EE72D]" />
                      </div>
